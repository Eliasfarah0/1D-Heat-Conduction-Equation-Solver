...
class Analysis {
	...
	public:
		...
		void setT_surf(double Tsurf); // void setTsurf(int Tsurf);
		void setT_init(double Tinit); // void setTinit(int Tinit);
		...
		// show the errrors i.e. absolute difference betwteen numerical values and analytic values at each nodes
		Vector printErrors(int scheme);
};
#endif